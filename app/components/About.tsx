...
export default function About() {
  const Card = ({ img, title, desc }: CardProps) => (
    <div className='rounded-xl bg-rich-blacks-main box-border  h-auto  flex flex-col items-start justify-end p-6 gap-[24px] mt-3 border-[2px] border-solid border-whites-01'>
      <div className='w-[239px] h-[196px] overflow-hidden shrink-0 flex flex-col items-center justify-start'>
        <img
